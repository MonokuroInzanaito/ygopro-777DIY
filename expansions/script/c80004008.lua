...
function c80004008.initial_effect(c)
	...
	e3:SetCondition(c80004008.descon)
	e3:SetTarget(c80004008.destg1)
	e3:SetOperation(c80004008.desop1)
	c:RegisterEffect(e3)
	--cannot be target
...
function c80004008.descon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetSummonType()==SUMMON_TYPE_SYNCHRO
end
function c80004008.desfilter(c)
	return c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToRemove()
end
function c80004008.destg1(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return Duel.IsExistingMatchingCard(c80004008.desfilter,tp,0,LOCATION_ONFIELD,1,c) end
	local sg=Duel.GetMatchingGroup(c80004008.desfilter,tp,0,LOCATION_ONFIELD,c)
	Duel.SetOperationInfo(0,CATEGORY_REMOVE,sg,sg:GetCount(),0,0)
		Duel.SetChainLimit(aux.FALSE)
end
function c80004008.desop1(e,tp,eg,ep,ev,re,r,rp)
	local sg=Duel.GetMatchingGroup(c80004008.desfilter,tp,0,LOCATION_ONFIELD,e:GetHandler())
