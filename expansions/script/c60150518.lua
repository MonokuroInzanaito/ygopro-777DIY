...
function c60150518.filter(c)
	return c:IsSetCard(0xab20) and c:IsType(TYPE_MONSTER) and c:GetLevel()==10 and c:IsFaceup()
end
function c60150518.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=Duel.SelectTarget(tp,c60150518.filter,tp,LOCATION_REMOVED,0,1,2,nil,e,tp)
