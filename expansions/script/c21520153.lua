...
--	e2:SetCondition(c21520153.pcon)
...
function c21520153.pcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c21520153.tgfilter,tp,LOCATION_DECK,0,1,nil)
end
function c21520153.ptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c21520153.tgfilter,tp,LOCATION_DECK,0,1,nil) end
...
function c21520153.pop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsLocation(LOCATION_GRAVE) then
		...
		local g=Duel.SelectMatchingCard(tp,c21520153.tgfilter,tp,LOCATION_DECK,0,1,1,nil)
