...
function c5012603.spfilter(c,e,tp)
	return (c:IsSetCard(0x350) or c:IsSetCard(0x23c) or c:IsSetCard(0x997) ) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and  c:IsType(TYPE_TUNER) and c:GetLevel()==2
end
