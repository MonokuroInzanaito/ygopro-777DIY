...
function c19300099.spcon2(e,tp,eg,ep,ev,re,r,rp)
	...
	return c:IsReason(REASON_EFFECT) and re:GetHandler():IsSetCard(0x193) and c:IsLocation(LOCATION_GRAVE)
end
...
function c19300099.filter(c)
	return c:IsSetCard(0x193) and c:GetAttack()<=600 and c:IsType(TYPE_MONSTER) and (c:IsAbleToHand() or c:IsAbleToGrave())
end
