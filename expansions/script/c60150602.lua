...
function c60150602.filter1(c,e,tp)
...
function c60150602.target2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		local mg1=Duel.GetMatchingGroup(c60150602.filter1,tp,LOCATION_MZONE+LOCATION_HAND,0,nil,e,tp)
