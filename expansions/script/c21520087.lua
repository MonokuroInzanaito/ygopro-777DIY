...
function c21520087.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcFun2(c,c21520087.fsfilter,c21520087.fsfilter,true)
	--spsummon condition
...
function c21520087.sprcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-2
		and Duel.IsExistingMatchingCard(c21520087.spfilter,tp,LOCATION_MZONE,0,2,nil)
end
function c21520087.sprop(e,tp,eg,ep,ev,re,r,rp,c)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TODECK)
	local g=Duel.SelectMatchingCard(tp,c21520087.spfilter,tp,LOCATION_MZONE,0,2,2,nil)
