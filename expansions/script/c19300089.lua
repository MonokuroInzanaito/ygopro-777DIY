...
function c19300089.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(c19300089.cfilter,tp,LOCATION_GRAVE,0,nil)
...
function c19300089.atkval(e,c)
	local g=Duel.GetMatchingGroup(c19300089.cfilter,c:GetControler(),LOCATION_GRAVE,0,nil)
