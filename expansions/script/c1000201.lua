...
function c1000201.initial_effect(c)
	...
	e1:SetCondition(c1000201.recon11)
	...
	e2:SetCondition(c1000201.condition)
	e2:SetCountLimit(1,793)
	e2:SetTarget(c1000201.distg)
	e2:SetOperation(c1000201.disop)
	c:RegisterEffect(e2)
end
function c1000201.recon11(e,tp,eg,ep,ev,re,r,rp)
	return bit.band(r,REASON_EFFECT)~=0
		and re:GetHandler():IsSetCard(0x200)
end
function c1000201.condition(e,tp,eg,ep,ev,re,r,rp)
