...
function c21520088.sprcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-2
		and Duel.IsExistingMatchingCard(c21520088.spfilter,tp,LOCATION_MZONE,0,2,nil)
end
function c21520088.sprop(e,tp,eg,ep,ev,re,r,rp,c)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TODECK)
	local g=Duel.SelectMatchingCard(tp,c21520088.spfilter,tp,LOCATION_MZONE,0,2,2,nil)
