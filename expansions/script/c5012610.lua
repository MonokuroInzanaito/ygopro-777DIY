...
function c5012610.initial_effect(c)
	...
	e1:SetCondition(c5012610.overcon)
	e1:SetOperation(c5012610.overop)
...
function c5012610.over(c,g)
	return c:IsFaceup() and (c:IsSetCard(0x350) or c:IsSetCard(0x23c) ) and c:IsCanBeXyzMaterial(g) and not c:IsType(TYPE_TOKEN) 
end
