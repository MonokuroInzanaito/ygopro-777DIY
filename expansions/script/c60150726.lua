...
function c60150726.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c60150726.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c60150726.spfilter,tp,LOCATION_HAND+LOCATION_GRAVE,0,1,nil,e,tp) 
