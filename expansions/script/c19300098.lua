...
function c19300098.initial_effect(c)
	...
	c:RegisterEffect(e2)
	Duel.AddCustomActivityCounter(19300098,ACTIVITY_SPSUMMON,c19300098.counterfilter)
end
function c19300098.counterfilter(c)
...
function c19300098.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c19300098.cffilter,tp,LOCATION_HAND,0,1,nil)
	and Duel.GetCustomActivityCount(19300098,tp,ACTIVITY_SPSUMMON)==0 end
	...
	e1:SetTarget(c19300098.splimit)
	Duel.RegisterEffect(e1,tp)
end
function c19300098.splimit(e,c,sump,sumtype,sumpos,targetp,se)
