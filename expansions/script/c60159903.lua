...
function c60159903.initial_effect(c)
    ...
    e11:SetCountLimit(1,60159903)
    e11:SetTarget(c60159903.target)
    e11:SetOperation(c60159903.operation3)
...
function c60159903.operation3(e,tp,eg,ep,ev,re,r,rp)
    local c=e:GetHandler()
    if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0 then return end
