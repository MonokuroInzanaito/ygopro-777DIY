...
function c11113038.splimit(e,se,sp,st)
	return bit.band(st,SUMMON_TYPE_FUSION)==SUMMON_TYPE_FUSION
end
function c11113038.spfilter(c)
	return c:IsFusionSetCard(0x15c) and c:IsType(TYPE_FUSION) and c:IsAbleToRemoveAsCost() and c:IsCanBeFusionMaterial()
end
