--风卷浪
function c32828002.initial_effect(c)
	--Activate
	...
	e1:SetCost(c32828002.cost)
	e1:SetTarget(c32828002.target)
	e1:SetOperation(c32828002.activate)
	c:RegisterEffect(e1)
end
function c32828002.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c32828002.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c32828002.activate(e,tp,eg,ep,ev,re,r,rp)
