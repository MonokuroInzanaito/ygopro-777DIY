...
function c11112034.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCondition(c11112034.dcon)
	e1:SetOperation(c11112034.dop)
	c:RegisterEffect(e1)
end
function c11112034.dcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return ep~=tp and (c==Duel.GetAttacker() or c==Duel.GetAttackTarget())
end
function c11112034.dop(e,tp,eg,ep,ev,re,r,rp)
