...
function c50000042.thop(e,tp,eg,ep,ev,re,r,rp)
	if not e:GetHandler():IsRelateToEffect(e) then return end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TODECK)
	local g=Duel.SelectMatchingCard(p,c50000042.tdfilter,tp,LOCATION_HAND,0,1,1,nil)
	local g1=Duel.SelectMatchingCard(p,c50000042.thfilter,tp,LOCATION_DECK,0,1,1,nil)
