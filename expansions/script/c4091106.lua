...
function c4091105.pencon(e,tp,eg,ep,ev,re,r,rp)
	...
	return sc and sc:IsSetCard(0x409) and  Duel.GetCurrentPhase()==PHASE_BATTLE 
end
function c4091105.penfilter(c)
	return c:IsSetCard(0x409) and c:IsType(TYPE_PENDULUM) and not c:IsCode(4091105) and not c:IsForbidden() and c:IsFaceup()
end
...
function c4091105.filter(c)
	return c:IsSetCard(0x409) and c:IsAbleToHand() and not c:IsCode(4091105) and not c:IsCode(4091106)
end
