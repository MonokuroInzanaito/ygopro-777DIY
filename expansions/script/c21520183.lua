...
function c21520183.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(21520183,5))
	...
	e7:SetDescription(aux.Stringid(21520183,4))
...
function c21520183.spfilter3(c)
	return (c:IsSetCard(0x490) or c:IsRace(RACE_FIEND)) and c:IsAbleToRemoveAsCost()
end
function c21520183.spcon(e,c)
	...
	return g:IsExists(c21520183.spfilter1,1,nil) and g:GetCount()>=3
end
function c21520183.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g1=Duel.GetMatchingGroup(c21520183.spfilter2,tp,LOCATION_MZONE+LOCATION_GRAVE+LOCATION_HAND,0,e:GetHandler())
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g2=g1:FilterSelect(tp,c21520183.spfilter1,1,1,nil)
	g1:Sub(g2)
	local g=g1:Select(tp,2,g1:GetCount(),nil)
	g:Merge(g2)
	c:SetMaterial(g)
...
function c21520183.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringid(21520183,3))
