...
--	e1:SetCountLimit(1)
	...
	e2:SetCategory(CATEGORY_TOHAND+CATEGORY_DECKDES+CATEGORY_TOGRAVE)
...
function c21520176.thfilter(c)
	return c:IsSetCard(0x490) and c:IsAbleToGrave()
end
...
function c21520176.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.IsExistingMatchingCard(c21520176.thfilter,tp,LOCATION_DECK,0,1,nil) then
		local g=Duel.SelectMatchingCard(tp,c21520176.thfilter,tp,LOCATION_DECK,0,1,1,nil)
