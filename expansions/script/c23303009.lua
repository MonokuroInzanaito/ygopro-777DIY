--轨迹-亚里欧斯
function c23303009.initial_effect(c)
	--act limit
	...
	e1:SetCondition(c23303009.accon)
	e1:SetValue(c23303009.aclimit)
	c:RegisterEffect(e1)
