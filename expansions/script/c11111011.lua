...
function c11111011.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(11111011,1))
...
function c11111011.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return e:GetHandler():IsType(TYPE_XYZ)
	    and Duel.IsExistingTarget(c11111011.filter,tp,0,LOCATION_MZONE,1,nil) end
...
function c11111011.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if Duel.SelectYesNo(tp,aux.Stringid(11111011,2)) then
