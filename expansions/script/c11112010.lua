...
function c11112010.initial_effect(c)
	...
	e3:SetValue(c11112010.splimit)
	c:RegisterEffect(e3)
end
function c11112010.splimit(e,se,sp,st)
...
function c11112010.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsPlayerCanDiscardDeck(tp,1) and Duel.GetCurrentPhase()==PHASE_MAIN1
