...
function c80006009.initial_effect(c) 
	...
	e1:SetDescription(aux.Stringid(80006009,0))
	e1:SetCategory(CATEGORY_DAMAGE)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1,91000041)
	e1:SetTarget(c80006009.damtg)
	e1:SetOperation(c80006009.damop)
	c:RegisterEffect(e1)
	--search
	...
	e2:SetCondition(c80006009.condition)
	e2:SetCost(c80006009.cost1)
	e2:SetTarget(c80006009.thtg1)
	e2:SetOperation(c80006009.tgop1)
	c:RegisterEffect(e2) 
	--ritual level
