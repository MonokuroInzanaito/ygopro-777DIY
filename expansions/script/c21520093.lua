...
function c21520093.atkfilter(e,c)
	return c:GetFlagEffect(21520093)~=0
end
function c21520093.valcon(e,tp,eg,ep,ev,re,r,rp)
	local rc=e:GetLabelObject()
	return rc:GetFlagEffect(21520093)~=0 and rc:IsFaceup() and rc:IsOnField()
end
...
function c21520093.resetop(e,tp,eg,ep,ev,re,r,rp)
	...
	if rc:GetFlagEffect(21520093)==0 then
		c:ResetFlagEffect(21520093)
	end
	if c:GetFlagEffect(21520093)==0 then
