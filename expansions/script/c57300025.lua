...
function c57300025.fgoal(g,fc,tp,chkf)
	local ct=g:GetCount()
	if chkf~=PLAYER_NONE and not g:IsExists(aux.FConditionCheckF,nil,chkf) then return false end
	--to be changed in mr4
	--if Duel.GetLocationCountFromEx(tp,tp,g,fc)<=0 then return false end
