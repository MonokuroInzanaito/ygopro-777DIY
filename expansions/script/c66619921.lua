...
function c66619921.xyzcon(e,c,og,min,max)
	...
	if ct<1 and (not min or min<=1) and mg:IsExists(c66619921.ovfilter,1,nil,tp,c) then
		return true
	end
	local minc=2
	local maxc=5
...
function c66619921.xyztg(e,tp,eg,ep,ev,re,r,rp,chk,c,og,min,max)
	...
	local b2=ct<1 and (not min or min<=1) and mg:IsExists(c66619921.ovfilter,1,nil,tp,c)
	local g=nil
