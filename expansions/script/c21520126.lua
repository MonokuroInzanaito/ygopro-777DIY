...
function c21520126.splimit(e,c,sump,sumtype,sumpos,targetp,se)
	return not (c:IsSetCard(0xc491) or c:IsSetCard(0x492))
end
function c21520126.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(Card.IsSetCard,tp,LOCATION_MZONE,LOCATION_MZONE,1,e:GetHandler(),0x491) 
