...
function c10173036.initial_effect(c)
	...
	if not c10173036.global_check then
		...
		ge5:SetOperation(c10173036.reset)
...
function c10173036.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e4:SetTarget(c10173036.tg2)
	Duel.RegisterEffect(e4,tp)
end
function c10173036.tg2(e,re,tp)
	return re:GetHandler():IsCode(table.unpack(Dark_Scl)) and re:IsActiveType(TYPE_MONSTER) and not re:GetHandler():IsImmuneToEffect(e)
end
