...
function c18702317.initial_effect(c)
	...
	e2:SetOperation(c18702317.checkop)
	c:RegisterEffect(e2)
	local e3=Effect.CreateEffect(c)
	e3:SetType(EFFECT_TYPE_CONTINUOUS+EFFECT_TYPE_SINGLE)
	e3:SetCode(EVENT_LEAVE_FIELD)
	e3:SetOperation(c18702317.desop)
	...
	e4:SetCondition(c18702317.descon2)
	e4:SetOperation(c18702317.desop2)
	c:RegisterEffect(e4)
	--direct
	--local e4=Effect.CreateEffect(c)
...
function c18702317.checkop(e,tp,eg,ep,ev,re,r,rp)
...
function c18702317.descon2(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetHandler():GetFirstCardTarget()
	return tc and eg:IsContains(tc) and tc:IsReason(REASON_DESTROY)
end
function c18702317.desop2(e,tp,eg,ep,ev,re,r,rp)
