...
function c21520015.rlevel(e,tp,eg,ep,ev,re,r,rp)
	...
	math.randomseed(c:GetFieldID()+Duel.GetFieldGroupCount(tp,LOCATION_DECK,0)+Duel.GetTurnCount()+17320)
...
function c21520015.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local spg=Duel.GetMatchingGroup(c21520015.spfilter,tp,LOCATION_EXTRA,0,nil,e,tp,lv)
...
function c21520015.spfilter(c,e,tp,lv)
