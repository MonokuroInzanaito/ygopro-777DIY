...
function c19300090.initial_effect(c)
	...
	e3:SetOperation(c19300090.regop)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
	e4:SetCode(EVENT_FLIP)
	c:RegisterEffect(e4)
end
function c19300090.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(19300090,RESET_EVENT+0x1ec0000+RESET_PHASE+PHASE_END,0,1)
end
...
function c19300090.spcon(e,tp,eg,ep,ev,re,r,rp)
	return tp==Duel.GetTurnPlayer() and e:GetHandler():GetFlagEffect(19300090)==0
end
