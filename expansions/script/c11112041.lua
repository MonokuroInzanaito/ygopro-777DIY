...
function c11112041.discost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupEx(tp,Card.IsSetCard,1,nil,0x15b) end
	local g=Duel.SelectReleaseGroupEx(tp,Card.IsSetCard,1,1,nil,0x15b)
...
function c11112041.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if e:GetHandler():IsRelateToEffect(e) then
		...
		if g:FilterCount(c11112041.cfilter,nil)>=3 then
