...
function c11113008.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return sc and sc:IsSetCard(0x15c)
end	
...
function c11113008.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Destroy(e:GetHandler(),REASON_EFFECT)~=0 then
		...
		local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c11113008.filter),tp,LOCATION_GRAVE+LOCATION_EXTRA,0,1,1,nil)
