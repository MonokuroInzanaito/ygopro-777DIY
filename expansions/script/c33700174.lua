...
function c33700174.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(33700174,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1)
	e1:SetTarget(c33700174.target)
	e1:SetOperation(c33700174.operation)
	c:RegisterEffect(e1)
   --special summon rule
	...
	e2:SetCondition(c33700174.spcon)
	e2:SetOperation(c33700174.spop)
	c:RegisterEffect(e2)
end
function c33700174.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c33700174.operation(e,tp,eg,ep,ev,re,r,rp)
	local hg=Duel.GetFieldGroupCount(tp,LOCATION_HAND,0)
