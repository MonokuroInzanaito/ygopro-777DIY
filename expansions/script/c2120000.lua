...
function c2120000.costfilter(c)
	return c:IsFaceup() and c:IsSetCard(0xb219) and c:IsType(TYPE_MONSTER)
end
...
function c2120000.filter(c,e,tp)
	return c:IsSetCard(0xb219) and c:IsLevelAbove(5) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c2120000.cfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0xb219) and c:IsDiscardable() and c:IsAbleToGraveAsCost()
end
