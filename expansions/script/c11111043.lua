...
function c11111043.thfilter(c)
	return c:IsSetCard(0x15d) and not c:IsCode(11111043) and c:IsAbleToHand()
end
function c11111043.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c11111043.thfilter,tp,LOCATION_DECK,0,1,nil) end
