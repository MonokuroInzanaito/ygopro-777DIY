...
cm.filters={
	...
	[1]=function(c) return c:IsType(TYPE_SPELL) end,
	[2]=function(c) return c:IsType(TYPE_TRAP) end,
}
function cm.xyzfilter(c,mg,sg,tp,xyzc)
	...
	if sg:GetCount()==3 then
		res=Duel.GetLocationCount(tp,LOCATION_MZONE)+sg:FilterCount(Card.IsLocation,nil,LOCATION_MZONE)>0
