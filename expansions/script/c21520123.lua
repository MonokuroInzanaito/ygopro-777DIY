...
function c21520123.condition(e,tp,eg,ep,ev,re,r,rp)
	return (Duel.IsExistingMatchingCard(c21520123.filter,0,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil)
		or Duel.IsEnvironment(21520133)) and ev>=1800 and Duel.IsPlayerCanSpecialSummon(tp) and ep==tp
end
