...
function c21520174.initial_effect(c)
	...
	e3:SetCondition(c21520174.ccon)
	e3:SetOperation(c21520174.ccost)
	c:RegisterEffect(e3)
	--draw
...
function c21520174.ccost(e,tp)
	...
	elseif g1:GetCount()>0 then
		opselect=Duel.SelectOption(tp,aux.Stringid(21520174,0),aux.Stringid(21520174,2))
...
function c21520174.spfilter(c,e,tp)
	return c:IsSetCard(0x490) and c:IsCanBeEffectTarget(e) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_SPECIAL,tp,false,false)
end
