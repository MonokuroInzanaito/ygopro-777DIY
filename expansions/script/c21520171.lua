...
function c21520171.thfilter(c,tp)
	return c:IsSetCard(0x490) and c:IsAbleToHand() and Duel:IsPlayerCanDraw(tp,1)
end
...
function c21520171.ccost(e,tp)
	...
	elseif g1:GetCount()>0 then
		opselect=Duel.SelectOption(tp,aux.Stringid(21520171,0),aux.Stringid(21520171,2))
