...
function c21520096.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingTarget(c21520096.filter1,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil,e,tp) end
