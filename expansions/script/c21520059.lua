...
function c21520059.filter1(c,e,tp)
...
function c21520059.fstg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		local mg1=Duel.GetMatchingGroup(c21520059.filter1,tp,LOCATION_MZONE+LOCATION_HAND+LOCATION_GRAVE+LOCATION_REMOVED,0,e:GetHandler(),e,tp)
