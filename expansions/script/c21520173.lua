...
function c21520173.initial_effect(c)
	...
	e3:SetCondition(c21520173.ccon)
	e3:SetOperation(c21520173.ccost)
	c:RegisterEffect(e3)
	--draw
...
function c21520173.ccost(e,tp)
	...
	elseif g1:GetCount()>0 then
		opselect=Duel.SelectOption(tp,aux.Stringid(21520173,0),aux.Stringid(21520173,2))
