...
function c21520166.ccost(e,tp)
	...
	elseif g1:GetCount()>0 then
		opselect=Duel.SelectOption(tp,aux.Stringid(21520166,0),aux.Stringid(21520166,2))
...
function c21520166.adfliter1(c)
	return c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsFaceup()
end
function c21520166.adfliter2(c)
	return c:IsAttribute(ATTRIBUTE_DARK) and c:IsFaceup()
end
function c21520166.adval(e,c)
	return (Duel.GetMatchingGroupCount(c21520166.adfliter1,c:GetControler(),LOCATION_GRAVE+LOCATION_MZONE,LOCATION_GRAVE+LOCATION_MZONE,nil)+Duel.GetMatchingGroupCount(c21520166.adfliter2,
	c:GetControler(),LOCATION_GRAVE+LOCATION_MZONE,LOCATION_GRAVE+LOCATION_MZONE,nil))*200
end
